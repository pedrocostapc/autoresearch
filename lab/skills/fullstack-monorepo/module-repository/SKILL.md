...
- Reaproveite contratos de `@poupig/shared` sempre que houver encaixe claro.
...
- Reaproveite o namespace compartilhado exposto pelo projeto, por exemplo `@poupig/shared`.
