---
name: fluxo-implementacao-3-agentes
type: skill
status: candidate
created: 2026-06-12
nights_used: 0
source: inbox 00-FLUXO-IMPLEMENTACAO.md (3 cópias idênticas; protocolo do próprio Pedro)
---

Protocolo de trabalho Pedro ↔ Claude (chat) ↔ Claude Code validado em 20+ PRs
com zero bugs em produção. Use como referência de gates em qualquer projeto:
investigação read-only primeiro, validação antes de implementar, diff antes
de commit, SQL manual pelo Pedro, merge só com OK explícito.
